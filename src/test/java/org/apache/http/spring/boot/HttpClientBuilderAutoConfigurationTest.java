...
/**
 * Unit tests for {{ @link HttpClientBuilderAutoConfiguration }}.
 *
...
class HttpClientBuilderAutoConfigurationTest {
    ...
    void testInstantiation() {
        HttpClientBuilderAutoConfiguration configuration = new HttpClientBuilderAutoConfiguration();
    ...
    void testLoadsWhenEnabledPropertySet() {
        runner.withUserConfiguration(HttpClientBuilderAutoConfiguration.class)
                .withPropertyValues("spring.boot.enabled=true")
                .run(context -> assertThat(context).hasSingleBean(HttpClientBuilderAutoConfiguration.class));
    }
    ...
    void testNotLoadedWhenPropertyAbsent() {
        runner.withUserConfiguration(HttpClientBuilderAutoConfiguration.class)
                .run(context -> assertThat(context).doesNotHaveBean(HttpClientBuilderAutoConfiguration.class));
    }
}
